        ...
        <div class="card-body">
          <form action="{{ route('order.update',$order->order_id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <x-adminlte-select2 name="customer_id" id="customer">
                  ...
                  <option value="{{ $c->customer_id}}" @if($order->customer_id == $c->customer_id) {{ 'selected'}} @endif
                    >{{ $c->fullname }}</option>
                  @endforeach
                </x-adminlte-select2>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <x-adminlte-select2 name="book_id" id="book">
                  ...
                  <option value="{{ $b->book_id}}" @if($order->book_id == $b->book_id)
                    {{ 'selected'}}
                    @endif
                    >{{ $b->title }}
                  </option>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="number" class="form-control" id="price" readonly value="{{ $order->price}}">
              </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="number" class="form-control" name="total" id="total" readonly value="{{ $order->total}}">
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="number" class="form-control" name="amount" id="amount" value="{{ $order->amount }}">
              </div>
            </div>
            <div class="row mb-3">
